%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%% the MOTTAZ LaTeX PREAMBLE (HOMEWORK) %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% v. 2.01 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%    Author: Anthony Mottaz
%    Version: 2.01  (2016/04/03)
...
%                 lots of preloaded packages and features that are useful for
...
%                add '\input{path/to/homework_preamble.tex}' where
%                'path/to/homework_preamble.tex'
