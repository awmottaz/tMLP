...
%% Description: This is my customized preamble with which I write all of my
%%	homework assignments. It is ever-expanding to fit new and nitpicky uses.
%% Please refer to the README for change log, goals for the future, and other
%%	info.
...
% I prefer a proof to start on a new page if 3 lines or fewer of the proof
%	will only be seen on a single page. The 'needspace' package does this for
%	me quite nicely.
